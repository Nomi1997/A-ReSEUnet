...
if __name__ == '__main__':
    ...
    for run_no in range(10):
        dataset_name = "MoNuSeg"  # MoNuSeg  CoNSeP  CPM17
        train_mode_type = "_normal"  # "_finetune_100"  _normal 
        model_type = "noSelf"  # Master  noAtt  noSelf  noSelfnoAtt
        preprocessing_mode = "modistain"  # modistain  normalstain nopreprocessing
        other_infor = "_nosplit"
        post_type = "_post_new"  # _post_new  _post_old
        folder_name = "Exam001_Test1101_" + dataset_name + "_" + model_type + "_" + preprocessing_mode + train_mode_type + "_" + other_infor + str(run_no)
