...
class UNet_3Plus(nn.Module):
    ...
    def __init__(self, in_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=True):
        ...
        # self.maxpool1 = nn.Conv2d(in_channels=filters[0], out_channels=filters[0], kernel_size=2, stride=2)

        self.conv2 = unetConv2(filters[0], filters[1], self.is_batchnorm)
        self.maxpool2 = nn.MaxPool2d(kernel_size=2)
        # self.maxpool2 = nn.Conv2d(in_channels=filters[1], out_channels=filters[1], kernel_size=2, stride=2)

        self.conv3 = unetConv2(filters[1], filters[2], self.is_batchnorm)
        self.maxpool3 = nn.MaxPool2d(kernel_size=2)
        # self.maxpool3 = nn.Conv2d(in_channels=filters[2], out_channels=filters[2], kernel_size=2, stride=2)

        self.conv4 = unetConv2(filters[2], filters[3], self.is_batchnorm)
        self.maxpool4 = nn.MaxPool2d(kernel_size=2)
        # self.maxpool4 = nn.Conv2d(in_channels=filters[3], out_channels=filters[3], kernel_size=2, stride=2)
...
###########################################################
'''GoogLeNet and InceptionAuX'''
class GoogLeNet(nn.Module):
    def __init__(self, num_classes=2, aux_logits=False, init_weights=False):
...
def googlenet_fcn(pretrained=None, num_classes=1):
...
class GoogLeNetFCN(nn.Module):
    ...
    def __init__(self, num_classes=1, transform_input=False):
